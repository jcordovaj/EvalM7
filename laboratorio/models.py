...
class Laboratorio(models.Model):
    ...
    alias_lab = models.CharField(max_length=255, verbose_name='alias')
...
class Producto(models.Model):
    ...
    f_expiracion = models.IntegerField(choices=anios_choices, default=anio_actual, verbose_name='F Expiración') 
